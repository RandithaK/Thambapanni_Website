        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex flex-col items-center md:items-start">
              ...
              <h2 className="text-xl font-bold text-sky-500 mb-2">Thambapanni</h2>
              <p className="text-sm text-gray-400 mb-4 max-w-xs">
                The 21st century app for exploring Sri Lanka's rich cultural heritage and natural beauty
              </p>
              <div className="flex gap-4">
                <a href="https://github.com/nethmalgunawardhana/Thambapanni" target="_blank" rel="noopener noreferrer" className="text-sky-400 hover:text-white transition-colors duration-300">
                ...
                <a href="https://www.linkedin.com/in/nethmal-gunawardhana-12a9b8272/" target="_blank" rel="noopener noreferrer" className="text-sky-400 hover:text-white transition-colors duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                  </svg>
                </a>
                <a href="mailto:contact@thambapanni.com" className="text-sky-400 hover:text-white transition-colors duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Team section */}
          <div className="col-span-1">
            <h6 className="text-lg font-semibold mb-4 text-sky-500">OUR TEAM</h6>
            <div className="flex flex-col space-y-2">
              {developers.map((dev, index) => (
                <a 
                  key={index}
                  href={dev.linkedIn}
                  className="block py-1 text-sky-400 hover:text-white transition-colors duration-300"
                  target="_blank"
          ...
          <div className="col-span-1">
            <h6 className="text-lg font-semibold mb-4 text-sky-500">REPOSITORIES</h6>
            <div className="flex flex-col space-y-2">
              <a 
          ...
          <div className="col-span-1">
            <div className="mb-4">
              <h6 className="text-lg font-semibold mb-4 text-sky-500">DOWNLOAD</h6>
              <div className="flex flex-col space-y-2">
                <a 
              ...
              <div className="mt-6">
                <button 
                  ...
                  className="btn bg-sky-600 hover:bg-sky-700 text-white border-none px-6 py-3 rounded-lg flex items-center gap-2 shadow-lg transition-all duration-300"
                >
