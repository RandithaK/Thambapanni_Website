  ...
  return (
    <div className="relative overflow-hidden h-screen flex items-center">
      ...
      >
        ...
        <div className="hero-content flex-col md:flex-row-reverse items-center justify-between w-full max-w-7xl px-6 md:px-12 relative z-10">
          {/* Content Section */}
          <div
          ...
          >
            <div className="mb-4 md:mb-6">
              <img src={thambapanniLogo} alt="Thambapanni Logo" className="h-16 md:h-20 mx-auto md:mx-0" />
            </div>
            <h1 className="mb-4 text-4xl md:text-6xl font-bold">
              Thambapanni<br />
            </h1>
            <span className="text-sky-500 text-3xl md:text-5xl font-bold drop-shadow-lg">TRAVEL APP</span>

            <p className="mb-4 text-xl md:text-2xl font-light">
              Plan your perfect Sri Lankan adventure
            </p>
            <div className="border-l-4 border-sky-700 pl-4 mb-6 mx-auto md:mx-0 text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <button
                className="btn bg-sky-800 text-white hover:bg-sky-900 transition-all duration-300 shadow-lg border-none flex items-center"
          ...
          {/* Phone Mockup (Appears below text on mobile) */}
          <div
            className={`transition-all duration-1000 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
          >
            <div className="transform scale-35 sm:scale-40 md:scale-50">
              <div className="mockup-phone border-sky-300">
                <div className="mockup-phone-camera"></div>
                <div className="mockup-phone-display">
                  <img alt="wallpaper" src={image1} className="object-cover" />
                </div>
              </div>
            </div>
          </div>
        ...
        <button
          ...
          className="absolute bottom-6 left-1/2 transform -translate-x-1/2 animate-bounce cursor-pointer focus:outline-none focus:ring-2 focus:ring-sky-700 rounded-full p-3 bg-sky-800/20 backdrop-blur-sm hover:bg-blue-800/40 transition-all z-20"
